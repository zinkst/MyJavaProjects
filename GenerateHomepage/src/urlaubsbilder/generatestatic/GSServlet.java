...
{
  private static final long serialVersionUID = 2824664759059863174L;
  ...
  */
  public void performTask(HttpServletRequest req, HttpServletResponse res)
  {
    ...
    try
    {
      ...
      if (mode.equalsIgnoreCase("single"))
      {
        ...
        urlaubId = urlaubId.replace('#', File.separator.charAt(0));
        processUrlaub();
      }
      else
      {
  ...
  public void processUrlaub()
  {
    try
    {
      ...
      session.invalidate();
      session = request.getSession(true);
      String bilderRoot = new String(inputRoot+File.separator+urlaubPrefix+"Photos"+File.separator);
      String urlaubBildPath = new String(urlaubId + File.separator + request.getParameter("pictureResolution"));
      urlaubBildPath = urlaubBildPath.replace('#', File.separator.charAt(0));
      dirContent.execute( bilderRoot,urlaubBildPath );
