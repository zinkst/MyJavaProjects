package org.zifts.homepagegenerator.util;

import java.util.*;

/**
 * Insert the type's description here. Creation date: (16.11.2000 16:12:47)
 * 
 * @author: Stefan Zink
 */
public class DirContent
{
  ...
  protected PropertyResourceBundle configBundle = null;
  private java.lang.String[] fieldAllPicturePaths = null;
  private String propertyFilename = "homepage.properties";
  ...
  {
    super();
    configBundle = (PropertyResourceBundle) PropertyResourceBundle.getBundle(propertyFilename);
  ...
  public boolean execute(String urlaubId)
  {
    String bilderRoot = configBundle.getString("bilderRoot");
    String bildPath = configBundle.getString("urlaubId");
    return execute(bilderRoot,bildPath);
  }
  ...
  /**
   * Insert the method's description here. Creation date: (21.11.2000 11:03:41)
   * 
  ...
  /**
   * Insert the method's description here. Creation date: (21.11.2000 10:43:22)
   * 
   * @return java.io.File
   */
  /**
  ...
  /**
   * Insert the method's description here. Creation date: (29.12.2000 07:28:01)
   * 
   * @return java.lang.String
   */
   ...
   * Insert the method's description here. Creation date: (21.11.2000 10:43:22)
   * 
   * @param newPathFileObject
   *          java.io.File
   */
  /**
   * Insert the method's description here. Creation date: (16.11.2000 16:16:20)
   * 
   * @return java.lang.String
   */
  ...
  /**
   * Insert the method's description here. Creation date: (25.12.2000 14:07:40)
   * 
  ...
  /**
   * Insert the method's description here. Creation date: (29.12.2000 08:33:16)
   * 
   * @return java.lang.String
   * @param i
   *          int
  ...
  /**
   * Insert the method's description here. Creation date: (25.12.2000 16:12:21)
   * 
   * @return java.lang.String
   * @param idx
   *          int
  ...
  public void initAllFiles()
  {
    ...
    for (int i = 0; i < PathFileObject.listFiles().length; i++)
    {
      ...
      if (ActualPicture.isValidPictureFile(pictureFilename))
      {
        ...
        // pictureServletLink = new String("<A
        // HREF=\"servlet/urlaubsbilder.ContentServlet?actualPicture=" +
        // PathFileObject.listFiles()[i].getPath() + "\" TARGET = \"content\" ID
        // =\"smallink\">" + picturename + "</A>" );
    ...
    /*
     * Iterator e = PictureHashMap.values().iterator(); while(e.hasNext()) {
     * System.out.println( (String)e.next()); }
     * System.out.println("initAllFilesHREF() passed with " + counter +"
     * elements \n" );
     */
