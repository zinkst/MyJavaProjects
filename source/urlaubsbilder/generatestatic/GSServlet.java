...
public void generateFile(String PictureName, int indexInDir)
{
  ...
  */
  ...
  try
  {
	...
	if (withHiresLink)
	{
	    out.write("<A href=\"../../../UrlaubsPhotosHires/" + urlaubId + "/hires/" + PictureName + "\" ><IMG id=\"homepic\" src=\"../../../images/b_ico005.gif\"> Right click on disk icon and select save link as to download Hires Picture </A>");
	}
	  out.write("<BR>");
	out.newLine();
	out.write(purePictureName);
	...
	out.write("<BR> ");
	out.newLine();
	out.write("<IMG src=\"../../../UrlaubsPhotos/" + urlaubId + "/" + request.getParameter("pictureResolution")+"/" + PictureName + "\" >");
	out.newLine();
	out.write("</BODY>");
	out.newLine();
	out.write("</HTML>");
...
{
  String outputFileName = targetPath + File.separator + "UrlaubsPages" + File.separator + urlaubId + File.separator+"c_menu.html";	
  ...
  try
  {
	...
	MenuWriter.write("</HEAD>");
	MenuWriter.newLine();
	MenuWriter.write("<BODY bgcolor=\"#3333FF\" text=\"#333333\" link=\"#006633\" vlink=\"#0000FF\" alink=\"#ff6699\" background=\"../../images/g_bcg006.gif\" >");
	MenuWriter.newLine();
	MenuWriter.flush();
  }
   catch (IOException e)
...
{
  String outputFileName = targetPath + File.separator + "UrlaubsPages" + File.separator + urlaubId + File.separator+"c_title.html";	
  ...
  TitlePageWriter.newLine();
	...
	TitlePageWriter.write("</HEAD>");
	TitlePageWriter.newLine();
	TitlePageWriter.write("<BODY bgcolor=\"#3333FF\" text=\"#333333\" link=\"#006633\" vlink=\"#0000FF\" alink=\"#ff6699\" background=\"../../images/g_bcg006.gif\" >");
	TitlePageWriter.newLine();
  TitlePageWriter.write("<A href=\"../../index.html\" target=\"_top\"><IMG id=\"homepic\" src=\"../../images/cursive_home.gif\" border=\"0\"></A>"); 
	TitlePageWriter.newLine();
  TitlePageWriter.write("<div id=\"Titlename\" style=\"position:absolute; width:768px; height:40px; z-index:1; left: 141px; top: 3px\">"); 
	TitlePageWriter.newLine();
...
public void performTask(HttpServletRequest req, HttpServletResponse res)
{
  ...
  try
  {
    ...
    this.response=res;
	  ...
	  {
	    urlaubId = "1988bund";processUrlaub();
	    urlaubId = "1989bund";processUrlaub();
	    urlaubId = "1989dolomiten";processUrlaub();
	    urlaubId = "1991gardasee";processUrlaub();
	    urlaubId = "1992dolomiten";processUrlaub();
	    urlaubId = "1994clermontFerrand";processUrlaub();
	    urlaubId = "1994piemont";processUrlaub();
	    urlaubId = "1995norwegen";processUrlaub();
	    urlaubId = "1995irland";processUrlaub();
	    urlaubId = "1996neuseeland";processUrlaub();
	    urlaubId = "1996pyrenaen";processUrlaub();
	    urlaubId = "1997oetztalerRadmarathon";processUrlaub();
	    urlaubId = "1997skitourWeiskugel";processUrlaub();
	    urlaubId = "1997Lofoten";processUrlaub();
	    urlaubId = "1998island";processUrlaub();
	    urlaubId = "1999Girojuni";processUrlaub();
	    urlaubId = "1999Schweiz";processUrlaub();
	    urlaubId = "2000Wintour";processUrlaub();
	    urlaubId = "2000Canada";processUrlaub(); 
	    urlaubId = "2000USA";processUrlaub(); 
	    urlaubId = "2001Wintour";processUrlaub();
        urlaubId = "2001VernagtHuette";processUrlaub();
        urlaubId = "2001Gardasee";processUrlaub();
        urlaubId = "2001Salzkammergut";processUrlaub();
  	}
...
{
  String outputFileName = targetPath + File.separator + "UrlaubsPages" + File.separator + urlaubId + File.separator + "c_start_"+ language+".html";
  ...
  try
  {
	...
	else
	{
	  ...
	  StartPageWriter.newLine();
		...
		if (language == "de")
		{  
			StartPageWriter.write("en.html\" target=\"_top\"><IMG id=\"ukpic\" src=\"../../images/flaguk.gif\" border=\"0\" width=\"44\" height=\"18\">English text</A><BR>");
		} 
		if (language == "en")
		{  
			StartPageWriter.write("de.html\" target=\"_top\"><IMG id=\"depic\" src=\"../../images/flagde.gif\" border=\"0\" width=\"44\" height=\"18\">German text</A><BR>");
		} 
		StartPageWriter.newLine();
